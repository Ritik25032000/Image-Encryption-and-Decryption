...
def signin():
    ...
    if(c==2):
        ...
        print("Hello Sir, If you forgot, username and password, click on forgot password button")
    if(c==3):
        es.sent_mail()
        root.destroy()
...
def onClick3():
    ...
    print("Welcome Sir,  If you forgot, username and password, click on forgot password button")
